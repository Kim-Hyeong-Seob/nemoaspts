...
try :      
        while 1 : 
            ...
            doc_ref1.set({
                ...
                'invertervoltage3' : 10 , 'sunvoltage3' : 0 , 'sunvoltage4' : 0 , 'MPPtime' : Development , 'pcbsignal' : pcbsignal,
                })
            ...
            if (len(Current_list)!=0) :
              doc_ref1.set({
                'id' : "system1", 'time' : utc_now , 'sunvoltage' : suncalv, 'invertervoltage1' : Dev_Current , 'invertervoltage2' : 10 ,
                'invertervoltage3' : 10 , 'sunvoltage3' : 0 , 'sunvoltage4' : 0 , 'MPPtime' : Development , 'pcbsignal' : pcbsignal, 'max_current' : max(Current_list)
                })
